...
public class PurchaserToHtmlConverter {
    public static String convert(PurchaserAggregatedModel purchaser, int index) {
    ...
    public static String convert(List<PurchaserAggregatedModel> purchasers) {
    ...
    private static String convertItems(List<MongoSelgrosItem> items) {
        return  String.join(", ",
            items.stream()
