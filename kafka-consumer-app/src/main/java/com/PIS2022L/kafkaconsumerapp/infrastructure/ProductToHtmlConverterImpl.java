...
@Service
public class ProductToHtmlConverterImpl implements ProductToHtmlConverter {

    @Override
    public String convert(ProductAggregatedModel product, int index) {
    ...
    @Override
    public String convert(List<ProductAggregatedModel> purchasers) {
        StringBuilder builder = new StringBuilder();
    ...
    private String convertOrders(List<MongoSelgrosOrder> items) {
